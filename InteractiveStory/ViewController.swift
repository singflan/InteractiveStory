...
//  InteractiveStory
//
//  Created by Dustin Flanary on 4/23/16.
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "startAdventure" {
            do {
                ...
                let alertController = UIAlertController(title: "Name Not Provided", message: "Provide your name to start your story!", preferredStyle: .Alert)
